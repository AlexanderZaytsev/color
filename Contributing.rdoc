...
I value any contribution to Colour you can provide: a bug report, a feature
request, or code contributions.

Code contributions to Colour are especially <del>welcome</del>encouraged.
Because Colour is a complex codebase, there are a few guidelines:
...
for Colour. If you have Bundler, you can accomplish this easily:

    $ bundle install

Colour uses Ryan Davis’s excellent {Hoe}[https://github.com/seattlerb/hoe]
